...
Uso de imágenes como recurso visual
------------------------------------------------------------------------------------
🎨 Paleta de colores
🖤 Negro → Elegancia y contraste
...
*Obtener sugerencias de diseño
*Mejorar estilos visuales

El uso de IA fue complementario al aprendizaje, manteniendo la comprensión del código y su funcionamiento.
------------------------------------------------------------------------------------
📌 Observación
--Este proyecto tiene fines académicos y forma parte del proceso de aprendizaje en desarrollo web.--
